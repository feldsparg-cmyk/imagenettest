...
<br><br>
소셜 미디어를 통해 이미지넷 룰렛이 확산되며 논란이 거세지자, 결국 이미지넷을 관리하던 연구팀은 <b>2019년 9월, 공식 사과와 함께 1,593개의 혐오·차별적 표현을 데이터베이스에서 전면 삭제</b>했다. 해당 카테고리에서만 60만장의 사진이 삭제되었고 분류 체계가 전면 수정되며 AI 업계에 변화를 이끌어 냈다.
<br><br>
